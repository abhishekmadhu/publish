...
### Create React App
2. **Lesson 20:** `create-react-app` makes life easier by creating a boilerplate application for us. It has all the necessary folder structure and [[GIT|GIT]]
...
![[undefined_assets/img/Pasted image 20220930075320.png|Pasted image 20220930075320.png]]
...
> [!note] But, if you are looking to just avoid prop drilling, [[React Udemy Course Notes#Component Composition] can be a better solution. 
...
![[undefined_assets/img/Pasted image 20220909110114.png|Pasted image 20220909110114.png]]
...
![[undefined_assets/img/React Reducers.svg|React Reducers.excalidraw]]
...
![[undefinedhidden/React Course Notes - Migrating the Cart Context Exercise|React Course Notes - Migrating the Cart Context Exercise]]

## Section 15: Redux Extended Tools
### Lesson 167: [[undefinedhidden/Redux Persist|Redux Persist]]
![[undefinedhidden/Redux Persist|Redux Persist]]

### Lesson 168: Redux-Devtools
[[undefinedhidden/202301142044 - filter function|filter functions]] are a great way to filter out middlewares based on condition. 
...
[[undefinedhidden/Redux Saga|Redux Saga]]
![[undefinedhidden/Redux Saga#^130f39|Redux Saga > ^130f39]]



# Additional Stuff / Appendix
### [[undefinedhidden/Component Composition|Component Composition]]
