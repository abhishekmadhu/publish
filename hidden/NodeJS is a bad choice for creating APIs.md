...
- [[undefinedhidden/NodeJS|NodeJS]] (and [[undefinedhidden/JavaScript|JavaScript]] in general) is [[asynchronous|asynchronous]].
...
- [[undefinedhidden/Nodejs is not ideal for CPU-intensive tasks|Nodejs is not ideal for CPU-intensive tasks]]
