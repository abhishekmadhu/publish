...
Easy to run [[undefinedhidden/Postgres|Postgres]] in [[undefinedhidden/Docker|Docker]] - summarized from [[How to Run PostgreSQL and pgAdmin Using Docker  by Mahbub Zaman  Towards Data Science|How to Run PostgreSQL and pgAdmin Using Docker  by Mahbub Zaman  Towards Data Science]]

Use the following [[undefinedhidden/Docker Compose|Docker Compose]] 
```yml
version: '3.8'
services:
  db:
...
3. To connect to [[undefinedhidden/Postgres|Postgres]] from [[pgAdmin|pgAdmin]], use the host `pg_container` (the name of the container that we defined in the [[undefinedhidden/Docker Compose|Docker Compose]] file) - 
