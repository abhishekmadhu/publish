...
Framework for [[undefinedhidden/OAuth 2|OAuth 2]]
...
## 5.1. (A) Authorization Request

## 5.2. (B) Authorization Granted by Resource Owner

## 5.3. (C) Request Access token using Authorization Grant

## 5.4. (D) Access token provided by Authorization Server

## 5.5. (E) Request protected resource using Access Token

## 5.6. (F) Get protected resource
...
### 6.1.1. Security Benefits of Authorization Code
...
### 6.1.2. PKCE - Proof Key for Code Exchange
...
## 6.3. Resource Owner Password Credentials
